...
export var HomeTheater = function HomeTheater(props) {
  return React.createElement(StyledIcon, {viewBox: "0 0 22 16",
    a11yTitle: "HomeTheater", ...props}, React.createElement("g", {
    stroke: "none",
    strokeWidth: "1",
    fill: "none",
    fillRule: "evenodd"
